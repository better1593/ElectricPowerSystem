...
def MC_Init():
    ...
    # 从表格中提取数值
    filename = 'PARA_MCLG\MC_InitInput.xlsx'
    ...
    inp6 = pd.read_excel(filename, sheet_name='Sheet6', index_col=0)
    ...
    # 更新 吸引半径AR
    AR = {
        'Phase1': inp6.values[0,:],
        'Phase2': inp6.values[1,:],
        'slopep': inp6.values[2,:],
        'buildingp': inp6.values[3,:]
    }
    ...
    return LatDis_max, Wave_Model, MC_lgtn, DSave, AR
